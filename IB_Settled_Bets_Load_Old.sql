...
, sb.NumLinesLose
, sb.NumLinesVoid
, (case when sb.CashOutStake <> 0 then 0 else pb.StakePerLine end) as StakePerLine
, (case when sb.CashOutStake <> 0 then 0 else pb.StakePerLineBC end) as StakePerLineBC
, (case when sb.CashOutStake <> 0 then 0 else pb.StakeAmt end) as StakeAmt
, (case when sb.CashOutStake <> 0 then 0 else pb.StakeAmtBC end) as StakeAmtBC
