...
(
	...
	where cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-15'
	group by 1
...
(
	...
	FROM 
	romaniamain.dim_calendar as cal
	left outer join romaniamain.sd_gv_daily_player_summary as dps on dps.SummaryDate <= cal.calendar_date and cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-15' and dps.SummaryDate >= '2015-11-26'
...
(
	...
	left outer join romaniamain.dim_player as p on pl.PlayerId = p.PlayerId and p.SignupDate >= '2015-11-26'	
	where  date(SettledDate) <= '2016-02-15'
...
(
	...
	where  date(Awarded_Date) <= '2016-02-15'
...
(
	...
	where date(pl.SummaryDate) <= '2016-02-15'
	and pl.AsOf = '2016-02-15'
) as WinRed on cal.calendar_date = WinRed.SummaryDate
where 
cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-15'
order by 1 
INTO OUTFILE 'C:\\Users\\Public\\Downloads\\test\\DayLevelSummary.csv'
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\r\n' ; 

LOAD DATA INFILE 'C:\\Users\\Public\\Downloads\\test\\DayLevelSummary.csv'
INTO TABLE romaniamain.FD_DayLevelSummary
