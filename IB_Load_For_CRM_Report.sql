...
Drop Table romaniafl.stg_dim_player; 
CREATE TABLE romaniafl.stg_dim_player (
...
Drop Table romaniafl.user_dep_with_first_last; 
CREATE TABLE romaniafl.user_dep_with_first_last (
...
Drop Table romaniafl.sp_gv_player_first_last; 
CREATE TABLE romaniafl.sp_gv_player_first_last (
   PlayerId bigint(20) NOT NULL,
...
Drop Table romaniafl.sp_cv_player_first_last_totals;
CREATE TABLE romaniafl.sp_cv_player_first_last_totals (
   PlayerId bigint(20) NOT NULL,
   SglLvFirstBetTime datetime DEFAULT NULL,
   SglLvFirstChannel varchar(20) DEFAULT NULL,
   SglLvFirstSelectionName varchar(500) DEFAULT NULL,
...
Drop Table romaniafl.eg_player_first_last_totals;
CREATE TABLE romaniafl.eg_player_first_last_totals (
   PlayerId bigint(20) NOT NULL,
...
Drop Table romaniafl.player_login_first_last;
CREATE TABLE romaniafl.player_login_first_last (
   PlayerId bigint(20) NOT NULL,
...
Drop Table romaniafl.cashier_extreme_deposits;
CREATE TABLE romaniafl.cashier_extreme_deposits (
...
Drop Table romaniafl.eg_player_extreme_bets; 
CREATE TABLE romaniafl.eg_player_extreme_bets (
   PlayerId int(11) DEFAULT NULL,
...
Drop Table romaniafl.SportsPreferedProduct;
CREATE TABLE romaniafl.SportsPreferedProduct (
   PlayerId int(11) DEFAULT NULL,
...
Drop Table romaniafl.egpreferedproduct;
CREATE TABLE romaniafl.egpreferedproduct (
   PlayerId int(11) DEFAULT NULL,
   CategoryPref varchar(200) DEFAULT NULL,
   MarketPref varchar(200) DEFAULT NULL
 ) ENGINE=BRIGHTHOUSE DEFAULT CHARSET=utf8;
 
Drop Table romaniafl.stg_sports_channel_pref;
CREATE TABLE romaniafl.stg_sports_channel_pref (
   PlayerId int(11) DEFAULT NULL,
   Channel varchar(200) DEFAULT NULL
 ) ENGINE=BRIGHTHOUSE DEFAULT CHARSET=utf8;
 
Drop Table romaniafl.stg_eg_channel_pref;
CREATE TABLE romaniafl.stg_eg_channel_pref (
   PlayerId int(11) DEFAULT NULL,
   Channel varchar(200) DEFAULT NULL
 ) ENGINE=BRIGHTHOUSE DEFAULT CHARSET=utf8;
 
Drop Table romaniafl.PlayerValue;
CREATE TABLE romaniafl.PlayerValue (
   PlayerId int(11) DEFAULT NULL,
...
Drop Table romaniafl.f_player_lifetime_apd;
CREATE TABLE romaniafl.f_player_lifetime_apd (
   PlayerID bigint(20) NOT NULL,
   LTSystemAPD int(11) DEFAULT NULL,
...
Drop Table romaniafl.sp_cv_player_volatility;
CREATE TABLE romaniafl.sp_cv_player_volatility (
   PlayerId int(11) DEFAULT NULL,
...
Drop table romaniafl.eg_lt_player_points;
CREATE TABLE romaniafl.eg_lt_player_points (
   PlayerId int(11) DEFAULT NULL,
...
Load data infile 'C:\\Users\\CSQ-MARK5-REP-LAYER\\Desktop\\RomaniaDataDump\\FL_Backup\\CRM\\DimPlayerChannel.csv'
