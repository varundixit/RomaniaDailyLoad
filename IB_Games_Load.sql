...
select count(*) from romaniamain.DIM_CLIENT_PARAMETER;
select count(*) from romaniamain.dim_game_list;
...
LOAD DATA INFILE 'C:\\Users\\CSQ-MARK5-REP-LAYER\\Desktop\\RomaniaDataDump\\CURL_Games\\Curl_Games2016-01-04.csv' 
...
select count(1) from STG_GAMES where date(GameDate) = '2016-01-04';
...
where date(stg.GameDate) <= '2016-01-04';
