...
where cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-01'
group by 1
...
FROM 
romaniamain.dim_calendar as cal
left outer join romaniamain.sd_gv_daily_player_summary as dps on dps.SummaryDate <= cal.calendar_date and cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-01' and dps.SummaryDate >= '2015-11-26'
...
where  date(SettledDate) <= '2016-02-01'
group by date(SettledDate)
) as TokenPL on cal.calendar_date = TokenPL.SummaryDate
where 
cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-01'
order by 1 ;