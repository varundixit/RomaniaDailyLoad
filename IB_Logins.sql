...
LoginDeviceTypeCode,
LoginVenueCode
INTO OUTFILE 'C:\\Users\\Public\\Downloads\\romaniastg\\LoginsNew.csv'
FIELDS TERMINATED BY '|' 
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'C:\\Users\\Public\\Downloads\\romaniastg\\LoginsNew.csv' 
...
INTO OUTFILE 'C:\\Users\\Public\\Downloads\\romaniastg\\LoginSplitsAcrossDates.csv'
#character set utf8
FIELDS TERMINATED BY ';' 
ENCLOSED BY 'NULL'
LINES TERMINATED BY '\r\n';
