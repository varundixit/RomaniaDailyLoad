...
, ((CashView.SPTotalStakeAmt - CashView.SPTotalWinAmt)+(CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))) as GrossWinAmt
, (((CashView.SPTotalStakeAmt - CashView.SPTotalWinAmt)*0.84)+((CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))*0.84)) as NetGrossWinAmt
...
, ((((CashView.SPTotalStakeAmt - CashView.SPTotalWinAmt)*0.84) - (TokenPL.BonusWinnings - WinRed.WinRedeemed)) + (((CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))*0.84) - ((CashView.EGBonusStakeAmt - CashView.EGBonusReturnAmt + coalesce(EGBonus.BonusRedeemed,0))))) as NetGamingRevenue
...
, (CashView.SPTotalStakeAmt - CashView.SPTotalWinAmt) as SPGrossWinAmt
, ((CashView.SPTotalStakeAmt - CashView.SPTotalWinAmt)*0.84) as SPNetGrossWinAmt
, TokenPL.BonusWinnings - WinRed.WinRedeemed as SPBonusCost
, (((CashView.SPTotalStakeAmt - CashView.SPTotalWinAmt)*0.84) - (TokenPL.BonusWinnings - WinRed.WinRedeemed)) as SPNetGamingRevenue
...
, (CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt)) as EGGrossWinAmt
, ((CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))*0.84) as EGNetGrossWinAmt
, (CashView.EGBonusStakeAmt - CashView.EGBonusReturnAmt + coalesce(EGBonus.BonusRedeemed,0)) as EGamingBonusCost
, (((CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))*0.84) - ((CashView.EGBonusStakeAmt - CashView.EGBonusReturnAmt + coalesce(EGBonus.BonusRedeemed,0)))) as EGNetGamingRevenue
, GameView.SystemAPD
, GameView.SportsAPD
, GameView.EGamingAPD
...
(
	...
	where cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-02'
	group by 1
...
(
	...
	,SUM(dps.SPCashStakeAmt+dps.SPCashOutStake) as SPTotalStakeAmt
	,SUM(dps.SPCashReturn+dps.SPCashOutWin) as SPTotalWinAmt
...
(
	...
	FROM 
	romaniamain.dim_calendar as cal
	left outer join romaniamain.sd_gv_daily_player_summary as dps on dps.SummaryDate <= cal.calendar_date and cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-02' and dps.SummaryDate >= '2015-11-26'
...
left outer join
(
	SELECT date(SettledDate) SummaryDate, sum(BonusWinnings) BonusWinnings FROM romaniamain.customer_pnl
	where  date(SettledDate) <= '2016-02-02'
...
(
	...
	where  date(Awarded_Date) <= '2016-02-02'
...
(
	...
	where date(pl.SummaryDate) <= '2016-02-02'
	and pl.AsOf = '2016-02-02'
) as WinRed on cal.calendar_date = WinRed.SummaryDate
where 
cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-02-02'
order by 1 ;