...
, ((CashView.SPCCStakeAmt - CashView.SPCCWinAmt)+(CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))) as GrossWinAmt
, (((CashView.SPCCStakeAmt - CashView.SPCCWinAmt)*0.84)+((CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))*0.84)) as NetGrossWinAmt
...
, ((((CashView.SPCCStakeAmt - CashView.SPCCWinAmt)*0.84) - (TokenPL.BonusWinnings - WinRed.WinRedeemed)) + (((CashView.EGCashStakeAmt - (CashView.EGCashReturnAmt + CashView.EGJackpotContributionAmt))*0.84) - ((CashView.EGBonusStakeAmt - CashView.EGBonusReturnAmt + coalesce(EGBonus.BonusRedeemed,0))))) as NetGamingRevenue
