...
where cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-01-10'
group by 1
...
FROM 
romaniamain.dim_calendar as cal
left outer join romaniamain.sd_gv_daily_player_summary as dps on dps.SummaryDate <= cal.calendar_date and cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-01-10' and dps.SummaryDate >= '2015-11-26'
...
where 
cal.calendar_date >= '2015-11-26' and cal.calendar_date <= '2016-01-10';